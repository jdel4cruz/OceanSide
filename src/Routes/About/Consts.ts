...
I settled on using Stripe to handle my user payments. In order to create the checkout session, a form created with React-Hook-Form \
is used to collect user data, and that data is sent to a simple backend created with NodeJS and Express where the session is generated.";
...
at other application designs as a reference.";
export const aboutClose =
  "If you read up to this part that means you managed to get through the essay above. If you'd like to see some of my other projects, please check out my GitHub!";
